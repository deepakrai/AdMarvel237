...
public class AdMarvelBannerAdsDemoActivity extends Activity implements AdMarvelViewListener{
		...
		button.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				try
				{
					...
					AdMarvelView adMarvelView = (AdMarvelView) findViewById(R.id.ad);
					adMarvelView.requestNewAd(targetParams, partnerId, siteId, AdMarvelBannerAdsDemoActivity.this);
				}
				catch (Exception e)
				{
